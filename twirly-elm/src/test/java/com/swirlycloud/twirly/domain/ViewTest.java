...
public final class ViewTest {
    ...
    public final void testToJson() throws IOException {
        ...
        final View view = new View(contr, settlDay, expiryDay, ladder, lastTicks, lastLots,
                lastTime);
        ...
        view.toJson(null, sb);
        assertEquals(
                "{\"id\":803163,\"contr\":\"EURUSD\",\"settlDate\":20140314,\"expiryDate\":20140311,\"bidTicks\":[12344,12343,12342],\"bidLots\":[10,20,30],\"bidCount\":[1,2,3],\"offerTicks\":[12346,12347,12348],\"offerLots\":[10,20,30],\"offerCount\":[1,2,3],\"lastTicks\":12344,\"lastLots\":5,\"lastTime\":1414932078620}",
                sb.toString());
        ...
        assertEquals(
                "{\"id\":803163,\"contr\":\"EURUSD\",\"settlDate\":20140314,\"expiryDate\":20140311,\"bidTicks\":[12344],\"bidLots\":[10],\"bidCount\":[1],\"offerTicks\":[12346],\"offerLots\":[10],\"offerCount\":[1],\"lastTicks\":12344,\"lastLots\":5,\"lastTime\":1414932078620}",
                sb.toString());
        ...
        assertEquals(
                "{\"id\":803163,\"contr\":\"EURUSD\",\"settlDate\":20140314,\"expiryDate\":20140311,\"bidTicks\":[12344,12343],\"bidLots\":[10,20],\"bidCount\":[1,2],\"offerTicks\":[12346,12347],\"offerLots\":[10,20],\"offerCount\":[1,2],\"lastTicks\":12344,\"lastLots\":5,\"lastTime\":1414932078620}",
                sb.toString());
        ...
        assertEquals(
                "{\"id\":803163,\"contr\":\"EURUSD\",\"settlDate\":20140314,\"expiryDate\":20140311,\"bidTicks\":[12344,12343,12342,null,null],\"bidLots\":[10,20,30,null,null],\"bidCount\":[1,2,3,null,null],\"offerTicks\":[12346,12347,12348,null,null],\"offerLots\":[10,20,30,null,null],\"offerCount\":[1,2,3,null,null],\"lastTicks\":12344,\"lastLots\":5,\"lastTime\":1414932078620}",
                sb.toString());
    }
    ...
    public final void testParse() throws IOException {
        final Contr contr = MockContr.newContr("EURUSD");
        final int settlDay = ymdToJd(2014, 2, 14);
        final int expiryDay = settlDay - 2;
        final Ladder ladder = new Ladder();
        ...
        final View in = new View(contr, settlDay, expiryDay, ladder, lastTicks, lastLots, lastTime);
