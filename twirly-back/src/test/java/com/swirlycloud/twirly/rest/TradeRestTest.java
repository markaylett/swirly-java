...
public final class TradeRestTest extends RestTest {
    ...
    public final void testGetByMarket() throws BadRequestException, NotFoundException,
        ...
        postOrder("MARAYL", "EURUSD.MAR14", 0, Side.SELL, 10, 12345, TODAY_MILLIS);
        postOrder("MARAYL", "EURUSD.MAR14", 0, Side.BUY, 10, 12345, TODAY_MILLIS);
        final Map<Long, Exec> out = unrest.getTrade("MARAYL", "EURUSD.MAR14", PARAMS_NONE,
                TODAY_MILLIS);
        assertEquals(2, out.size());
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.SELL, 10, 12345, 0, 10, 123450, 10,
                12345, "EURUSD", SETTL_DAY, Role.MAKER, "MARAYL", out.get(Long.valueOf(3)));
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.BUY, 10, 12345, 0, 10, 123450, 10,
                12345, "EURUSD", SETTL_DAY, Role.TAKER, "MARAYL", out.get(Long.valueOf(4)));
        assertTrue(unrest.getTrade("MARAYL", "USDJPY.MAR14", PARAMS_NONE, TODAY_MILLIS).isEmpty());
    }
    ...
    public final void testGetByMarketId() throws BadRequestException, NotFoundException,
        ...
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.BUY, 10, 12345, 0, 10, 123450, 10,
                12345, "EURUSD", SETTL_DAY, Role.TAKER, "MARAYL", out.get(Long.valueOf(4)));
        try {
            unrest.getOrder("MARAYL", "EURUSD.MAR14", 3, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
        try {
            unrest.getOrder("MARAYL", "EURUSD.MAR14", 4, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
    }
    ...
    public final void testArchiveSingle() throws BadRequestException, NotFoundException,
        ...
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.BUY, 10, 12345, 0, 10, 123450, 10,
                12345, "EURUSD", SETTL_DAY, Role.TAKER, "MARAYL", out.get(Long.valueOf(4)));
        deleteTrade("MARAYL", "EURUSD.MAR14", 3, TODAY_MILLIS);
        try {
            unrest.getTrade("MARAYL", "EURUSD.MAR14", 3, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
    }
    ...
    public final void testArchiveBatch() throws BadRequestException, NotFoundException,
            ServiceUnavailableException, IOException {
        postOrder("MARAYL", "EURUSD.MAR14", 0, Side.SELL, 10, 12345, TODAY_MILLIS);
        postOrder("MARAYL", "EURUSD.MAR14", 0, Side.SELL, 10, 12346, TODAY_MILLIS);
        postOrder("MARAYL", "EURUSD.MAR14", 0, Side.BUY, 20, 12346, TODAY_MILLIS);
        final Map<Long, Exec> out = unrest.getTrade("MARAYL", PARAMS_NONE, TODAY_MILLIS);
        assertEquals(4, out.size());
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.SELL, 10, 12345, 0, 10, 123450, 10,
                12345, "EURUSD", SETTL_DAY, Role.MAKER, "MARAYL", out.get(Long.valueOf(4)));
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.BUY, 20, 12346, 10, 10, 123450, 10,
                12345, "EURUSD", SETTL_DAY, Role.TAKER, "MARAYL", out.get(Long.valueOf(5)));
        assertExec("MARAYL", "EURUSD.MAR14", State.TRADE, Side.SELL, 10, 12346, 0, 10, 123460, 10,
        ...
        deleteTrade("MARAYL", "EURUSD.MAR14", jslList("EURUSD.MAR14", Long.valueOf(4),
                Long.valueOf(5), Long.valueOf(6), Long.valueOf(7)), TODAY_MILLIS);
        try {
            unrest.getTrade("MARAYL", "EURUSD.MAR14", 4, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
        try {
            unrest.getTrade("MARAYL", "EURUSD.MAR14", 5, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
        try {
            unrest.getTrade("MARAYL", "EURUSD.MAR14", 6, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
        try {
            unrest.getTrade("MARAYL", "EURUSD.MAR14", 7, PARAMS_NONE, TODAY_MILLIS);
            fail("Expected exception");
        } catch (final NotFoundException e) {
        }
    }
