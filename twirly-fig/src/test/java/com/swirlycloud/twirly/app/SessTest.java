...
public final class SessTest {
    ...
    public final void testAdd() {
        ...
        final Sess sess = new Sess(trader, refIdx);
        final Posn posn1 = new Posn(trader.getMnem(), "EURUSD", SETTL_DAY);
        posn1.addBuy(12344 * 10, 10);
        posn1.addSell(12346 * 15, 15);
        assertSame(posn1, sess.addPosn(posn1));
        final Posn posn2 = new Posn(trader.getMnem(), "EURUSD", SETTL_DAY);
