...
public final class PosnRestTest extends RestTest {
    ...
    public final void testGetAll() throws BadRequestException, NotFoundException,
        ...
        postOrder(MARAYL, USDJPY_MAR14, 0, Side.SELL, 10, 12345, TODAY_MS);
        postOrder(MARAYL, USDJPY_MAR14, 0, Side.BUY, 10, 12345, TODAY_MS);
        final Map<PosnKey, Posn> out = unrest.getPosn(MARAYL, PARAMS_NONE, TODAY_MS);
    ...
    public final void testGetByContr() throws BadRequestException, NotFoundException,
        ...
        postOrder(MARAYL, USDJPY_MAR14, 0, Side.SELL, 10, 12345, TODAY_MS);
        postOrder(MARAYL, USDJPY_MAR14, 0, Side.BUY, 10, 12345, TODAY_MS);
        final Map<PosnKey, Posn> out = unrest.getPosn(MARAYL, EURUSD, PARAMS_NONE, TODAY_MS);
    ...
    public final void testGetByContrSettlDay() throws BadRequestException, NotFoundException,
        ...
        postOrder(MARAYL, EURUSD_MAR14, 0, Side.SELL, 10, 12345, TODAY_MS);
        postOrder(MARAYL, EURUSD_MAR14, 0, Side.BUY, 10, 12345, TODAY_MS);
        final Posn posn = unrest.getPosn(MARAYL, EURUSD, SETTL_DAY, PARAMS_NONE, TODAY_MS);
        assertPosn(MARAYL, EURUSD_MAR14, EURUSD, SETTL_DAY, 10, 123450, 10, 123450, posn);
        try {
            unrest.getPosn(MARAYL, USDJPY, SETTL_DAY, PARAMS_NONE, TODAY_MS);
