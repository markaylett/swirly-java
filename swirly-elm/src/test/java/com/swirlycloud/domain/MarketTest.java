...
public final class MarketTest {
    ...
    public final void test() throws IOException {
        ...
        // Empty params.
        sb.setLength(0);
        market.toJson(Collections.<String, String> emptyMap(), sb);
        assertEquals(
                "{\"id\":803163,\"contr\":\"EURUSD\",\"settlDate\":20140314,\"expiryDate\":20140314,\"bidTicks\":[12344,12343,null],\"bidLots\":[5,10,null],\"bidCount\":[1,1,null],\"offerTicks\":[12346,null,null],\"offerLots\":[7,null,null],\"offerCount\":[2,null,null],\"lastTicks\":null,\"lastLots\":null,\"lastTime\":null}",
                sb.toString());
        ...
        // Explicit TOB.
        sb.setLength(0);
        market.toJson(Collections.singletonMap("depth", "1"), sb);
        assertEquals(
        ...
        sb.setLength(0);
        market.toJson(Collections.singletonMap("depth", "2"), sb);
        assertEquals(
        ...
        sb.setLength(0);
        market.toJson(Collections.singletonMap("depth", "100"), sb);
        assertEquals(
